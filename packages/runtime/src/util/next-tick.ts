...
const nextTickCallbacks: callbackType[] = [];
 ...
 */
export function addNextTickCallback(callback: callbackType): void;
export function addNextTickCallback(): Promise<void>;
export function addNextTickCallback(callback?: callbackType) {
  if (callback) {
